...
# Also increase segment/block size to see if repeats dont get matched in the graph
...
mkdir /lustre/scratch123/tol/projects/cichlid/ldekker/results/12_pggb_manual_communities_bigger_segments/chromosome${i}
OUTPUTDIR=/lustre/scratch123/tol/projects/cichlid/ldekker/results/12_pggb_manual_communities_bigger_segments/chromosome${i} 
...
../software/pggb/pggb -i ${INPUTDATA} -o ${OUTPUTDIR} -n 4 -t 8 -p 90 -s 20k -Y '#' 
