...
# Make stats files of filtered (>50bp) VCF files contained the structural variants between cichlids from minigraph-cactus pangenomes
...
INPUT=/lustre/scratch123/tol/projects/cichlid/ldekker/results/24_minigraph_cactus_communities/recon_pangenomes/chromosome${i}/minigraph_cactus_community${i}_lt50bp.vcf
OUTPUTDIR=/lustre/scratch123/tol/projects/cichlid/ldekker/results/40_bcftools_stats_vcf_minicactus
...
# bcftools
bcftools stats ${INPUT} > ${OUTPUTDIR}/minicactus_chr${i}_sv_stats.txt
